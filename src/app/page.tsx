...
import { HomepageScanDialog } from "@/components/HomepageScanDialog";
          ...
          <section className="mb-8 md:mb-12 flex flex-col items-center gap-4 animate-scale-in stagger-1">
            <Button
              ...
              className="w-full max-w-md sm:max-w-lg transform hover:scale-105 py-3.5 sm:py-4 text-lg sm:text-xl \
                         bg-gradient-to-br from-[hsl(230_60%_18%)] to-[hsl(210_70%_40%)]
hover:from-[hsl(230_60%_15%)] hover:to-[hsl(210_70%_35%)]"
                    ...
                    <div className="p-2 rounded-md hover:bg-muted/50 transition-colors flex items-center justify-between">
                      <div>
                        ...
                        <p className="text-xs text-muted-foreground">
                          {t("home_due_on_label")}{" "}
                          {kpiData.nextPaymentDueInvoice.dueDate
                            ? typeof kpiData.nextPaymentDueInvoice.dueDate ===
                              "string"
                              ? formatDateFns(
                                  parseISO(
                                    kpiData.nextPaymentDueInvoice.dueDate
                              ...
                              : kpiData.nextPaymentDueInvoice.dueDate instanceof
                                Timestamp
                              ? formatDateFns(
                                  kpiData.nextPaymentDueInvoice.dueDate.toDate(),
                                  "PP",
                                  {
                                    locale:
                                      t("locale_code_for_date_fns") === "he"
